module libssh.c_bindings.server;
...
alias ssh_bind = ssh_bind_struct*;
 ...
 */
alias ssh_bind_incoming_connection_callback = extern(C) void function(ssh_bind sshbind, 
    void *userdata);
...
alias ssh_bind_callbacks = ssh_bind_callbacks_struct*;
...
extern(C) {
    ...
    int ssh_bind_options_set(ssh_bind sshbind,
        ssh_bind_options_e type, const void *value);
    ...
    * @brief Allow the file descriptor to accept new sessions.
    ...
    int ssh_message_auth_interactive_request(ssh_message msg,
        ...
        uint num_prompts, const char **prompts, char *echo);
    ...
    alias ssh_bind_message_callback_type = extern(C) int function(ssh_session session, ssh_message msg, void *data);
    void ssh_set_message_callback(ssh_session session,
        ssh_bind_message_callback_type ssh_bind_message_callback,
        void *data);
...
//    int ssh_channel_open_x11(ssh_channel channel, const char *orig_addr, int orig_port);  // Dublicated in libssh.d
    ...
    deprecated int channel_write_stderr(ssh_channel channel,
