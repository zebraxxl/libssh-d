module libssh.c_bindings.callbacks;
 ...
 */
alias ssh_callback_int = extern(C) void function(int code, void *user);
 ...
 */
alias ssh_callback_data = extern(C) int function(const void *data, size_t len, void *user);

alias ssh_callback_int_int = extern(C) void function(int code, int errno_code, void *user);

alias ssh_message_callback = extern(C) int function(ssh_session, ssh_message message, void *user);
alias ssh_channel_callback_int = extern(C) int function(ssh_channel channel, int code, void *user);
alias ssh_channel_callback_data = extern(C) int function(ssh_channel channel, int code, void *data, 
 ...
 */
alias ssh_log_callback = extern(C) void function(ssh_session session, int priority, 
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_logging_callback = extern(C) void function(int priority, const char *function_, 
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_status_callback = extern(C) void function(ssh_session session, float status, 
    void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_global_request_callback = extern(C) void function(ssh_session session, 
 ...
 */
alias ssh_channel_open_request_x11_callback = extern(C) ssh_channel function(ssh_session session, 
...
struct ssh_callbacks_struct {
   ...
   */
    extern(C) void function(void *userdata, float status) connect_status_function;
    /**
 ...
 */
alias ssh_auth_password_callback = extern(C) int function(ssh_session session, const char *user, 
 ...
 * @returns SSH_AUTH_DENIED Authentication failed.
 */
alias ssh_auth_none_callback = extern(C) int function(ssh_session session, const char *user, 
    void *userdata);
 ...
 */
alias ssh_auth_gssapi_mic_callback = extern(C) int function(ssh_session session, const char *user, 
 ...
 * @returns SSH_AUTH_DENIED Authentication failed.
 */
alias ssh_auth_pubkey_callback = extern(C) int function(ssh_session session, const char *user, 
    ssh_key_struct *pubkey, byte signature_state, void *userdata);
 ...
 */
alias ssh_service_request_callback = extern(C) int function(ssh_session session, 
    const char *service, void *userdata);
 ...
 * @warning The channel pointer returned by this callback must be closed by the application.
 */
alias ssh_channel_open_request_session_callback = extern(C) ssh_channel function(
 ...
 * with libgssapi.
 */
alias ssh_gssapi_select_oid_callback = extern(C) ssh_string function(ssh_session session, 
    const char *user, int n_oid, ssh_string *oids, void *userdata);
 ...
 * with libgssapi.
 */
alias ssh_gssapi_accept_sec_ctx_callback = extern(C) int function(ssh_session session, 
 ...
 * with libgssapi.
 */
alias ssh_gssapi_verify_mic_callback = extern(C) int function(ssh_session session, ssh_string mic, 
    void *mic_buffer, size_t mic_buffer_size, void *userdata);
 ...
 */
extern(C) int ssh_set_server_callbacks(ssh_session session, ssh_server_callbacks cb);
...
enum auto SSH_SOCKET_FLOW_WRITEWILLBLOCK = 1;
enum auto SSH_SOCKET_FLOW_WRITEWONTBLOCK = 2;

enum auto SSH_SOCKET_EXCEPTION_EOF =       1;
enum auto SSH_SOCKET_EXCEPTION_ERROR =     2;

enum auto SSH_SOCKET_CONNECTED_OK =         1;
enum auto SSH_SOCKET_CONNECTED_ERROR =      2;
enum auto SSH_SOCKET_CONNECTED_TIMEOUT =    3;
 ...
 * evolves with time.
 */
void ssh_callbacks_init(T)(ref T p) {
    p.size = T.sizeof;
}
 ...
 */
alias ssh_packet_callback = extern(C) int function(ssh_session session, ubyte type, 
    ssh_buffer packet, void *user);

/** return values for a ssh_packet_callback */
/** Packet was used and should not be parsed by another callback */
enum auto SSH_PACKET_USED = 1;
/** Packet was not used and should be passed to any other callback
 * available */
enum auto SSH_PACKET_NOT_USED = 2;
 ...
 * @return SSH_OK on success, SSH_ERROR on error.
 */
extern(C) int ssh_set_callbacks(ssh_session session, ssh_callbacks cb);
 ...
 * be sent in the next callback message, when more data is available.
 */
alias ssh_channel_data_callback = extern(C) int function(ssh_session session, ssh_channel channel, 
    void *data, uint len, int is_stderr, void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_eof_callback = extern(C) void function(ssh_session session, ssh_channel channel, 
    void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_close_callback = extern(C) void function(ssh_session session, ssh_channel channel, 
    void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_signal_callback = extern(C) void function(ssh_session session, 
    ssh_channel channel, const char *signal, void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_exit_status_callback = extern(C) void function(ssh_session session, 
    ssh_channel channel, int exit_status, void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_exit_signal_callback = extern(C) void function(ssh_session session, 
    ssh_channel channel, const char *signal, int core, const char *errmsg, const char *lang, 
    void *userdata);
 ...
 */
alias ssh_channel_pty_request_callback = extern(C) int function(ssh_session session, 
    ssh_channel channel, const char *term, int width, int height, 
 ...
 * @returns 1 if the request is denied
 */
alias ssh_channel_shell_request_callback = extern(C) int function(ssh_session session, 
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_auth_agent_req_callback = extern(C) void function(ssh_session session, 
    ssh_channel channel, void *userdata);
 ...
 * @param userdata Userdata to be passed to the callback function.
 */
alias ssh_channel_x11_req_callback = extern(C) void function(ssh_session session, 
    ssh_channel channel, int single_connection, const char *auth_protocol, 
    const char *auth_cookie, uint screen_number, void *userdata);
 ...
 * @returns -1 if the request is denied
 */
alias ssh_channel_pty_window_change_callback = extern(C) int function(ssh_session session, 
    ssh_channel channel, int width, int height, int pxwidth, int pwheight, void *userdata);
 ...
 * @returns 1 if the request is denied
 */
alias ssh_channel_exec_request_callback = extern(C) int function(ssh_session session, 
    ssh_channel channel, const char *command, void *userdata);
 ...
 */
alias ssh_channel_env_request_callback = extern(C) int function(ssh_session session, 
    ssh_channel channel, const char *env_name, const char *env_value, void *userdata);
 ...
 * @returns 1 if the request is denied
 */
alias ssh_channel_subsystem_request_callback = extern(C) int function(ssh_session session, 
    ssh_channel channel, const char *subsystem, void *userdata);
 ...
 * @return SSH_OK on success, SSH_ERROR on error.
 */
extern(C) int ssh_set_channel_callbacks(ssh_channel channel, ssh_channel_callbacks cb);
...
alias ssh_thread_callback = extern(C) int function(void **lock);

alias ssh_thread_id_callback = extern(C) uint function();
 ...
 */
extern(C) int ssh_threads_set_callbacks(ssh_threads_callbacks_struct *cb);
...
version (LibSSHWithPThreads) {
     ...
     */
    extern(C) ssh_threads_callbacks_struct *ssh_threads_get_pthread();
}
 ...
 * @see ssh_threads_set_callbacks
 */
extern(C) ssh_threads_callbacks_struct *ssh_threads_get_noop();
 ...
 */
extern(C) int ssh_set_log_callback(ssh_logging_callback cb);
 ...
 */
extern(C) ssh_logging_callback ssh_get_log_callback();
